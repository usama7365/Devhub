  ...
  export function KnowledgeBase() {
    ...
    return (
      <div className="py-8">
        <div className="flex justify-between items-center mb-8 xs:flex-col xs:items-start">
          ...
          <div className=''>
          <Link to="/knowledge-base/new" className="btn xs:mt-2">
            ...
            <div className="space-y-6">
              {filteredArticles.map((article) => (
                ...
                >
                  ...
                  <div className="mt-4 flex items-center justify-between small:flex-col small:items-start">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 small:mt-3">
